...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'محمد') {  //WESO#0001
      msg.reply('**محمد هيرد لما يشوف الرسالة**');  //WESO#0001
    }
  });
...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' -help',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' لاحول ولا قوة الا بالله ','By محمد'];
    var i = -1;
    var j = 0;
